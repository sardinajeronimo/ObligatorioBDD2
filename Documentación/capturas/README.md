...
|---|---|---|
| `parte2_8_ranking_publicaciones.png` | 2.8 | Ranking de la comunidad "IA General" ordenado por `puntaje_total` desc, en grilla de SQL Developer (4 filas: puntaje, título, fecha, agente, admin). |
